...
impl Provider for AzureOpenAiProvider {
    ...
    /// Fetch the list of available models from the Azure OpenAI service.
    /// Azure OpenAI provides a models endpoint similar to OpenAI: {base_url}/models?api-version={api_version}
